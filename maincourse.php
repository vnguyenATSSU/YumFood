...
// Fetch only Main Course items from the database
$query = "SELECT * FROM menu_item WHERE item_category = 'Main Course'";
...
<head>
    ...
    <title>Yummi Food - Main Course</title>
...
<section class="hero">
    <h1>Main Course</h1>
    <p>Explore our delicious main course dishes!</p>
</section>
